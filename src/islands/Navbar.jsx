      ...
      >
        <div className="container-main">
          <div className="flex h-24 md:h-28 items-center justify-between gap-5">
            <a href="/" className="flex shrink-0 items-center gap-3 md:gap-4" aria-label="Saadi Construction Group home">
              <img
              ...
              <span className="flex flex-col leading-none text-[#fff8ed]">
                <span className="font-heading text-3xl font-medium uppercase tracking-[0.24em] md:text-4xl">SAADI</span>
                <span className="mt-1.5 font-body text-[9px] font-semibold uppercase tracking-[0.32em] md:text-[10px]">Construction Group</span>
              </span>
            </a>
