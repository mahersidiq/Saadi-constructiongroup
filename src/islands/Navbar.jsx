          ...
          <div className="fixed top-0 right-0 bottom-0 w-80 max-w-[85vw] bg-navy z-50 lg:hidden overflow-y-auto" style={{ animation: 'slideInRight 0.3s ease-out' }}>
            <div className="p-6">
              ...
              <div className="mt-8 space-y-4">
                <a href="/contact" className="block w-full text-center px-5 py-3 bg-gold text-white text-sm font-semibold rounded-lg">Request a Quote</a>
                <a href="tel:8322058178" className="flex items-center justify-center gap-2 text-white/80 text-sm">
